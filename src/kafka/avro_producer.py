...
if __name__ == '__main__':
    ...
    if not users_schema_response.schema_str:
        #avro_schema = avro.load(BASE_DIR+"resources/avro/UserService-Schema.avsc")
        schema_str = open(BASE_DIR+'resources/avro/UserService-Schema.avsc', 'r').read()
